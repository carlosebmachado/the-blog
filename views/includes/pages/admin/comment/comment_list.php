  ...
  <div class="col-sm bg-white m-1 p-3 rounded">
    <table class="table">
      ...
      <tbody>
        ...
        $comments = \models\Commentary::select_on_interval($page_amt, $offset);
        ...
        ?>
          <tr>
            ...
            <td>
              <a class="btn btn-info" href="<?php echo \Config::BASE_NAME . 'post?id=' . $comment->get_post_id() ?>" target="_blank">View</a>
            </td>
            <td>
