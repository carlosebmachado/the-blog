...
if (isset($_GET['comments']))
{
    ...
    foreach ($articles as $article)
    {
        ...
        for ($j = $tc; $j >= 0; $j--)
        {
            $c =  new \models\BlogPostCommentary(null, 'Person Name', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam porttitor ultrices augue, ut eleifend ipsum. Proin convallis augue ut nisl viverra, sit amet malesuada enim convallis. Quisque arcu diam, scelerisque sed molestie et, consequat in massa.', date('Y-m-d', strtotime($article->get_date()) + (rand(0, 5) * (60*60*24))), $article->get_id());
            $c->insert();
        }
    }
...
if (isset($_GET['messages']))
{
    for ($i = 50; $i >= 0; $i--)
    {
        $article = new \models\ContactMessage(null, 'Person Name','name@email', date('Y-m-d', time() + rand(0, 5) * (60*60*24)), 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam porttitor ultrices augue, ut eleifend ipsum. Proin convallis augue ut nisl viverra, sit amet malesuada enim convallis. Quisque arcu diam, scelerisque sed molestie et, consequat in massa.');
        $article->insert();
    }
